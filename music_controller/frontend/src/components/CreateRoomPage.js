...
export default class CreateRoomPage extends Component{
    ...
    handleUpdateButtonPresses() {
        ...
        fetch('/api/update-room', requestOptions).then((response) => {
            if (response.ok) {
                this.setState({
                    sucessMessage : "Room updated successfully!",
                });
            }
            else {
                this.setState({
    ...
    renderUpdateButtons()
    {
        return (
            <Grid item xs={12} align="center">
                <Button color="primary" variant="contained" onClick={this.handleUpdateButtonPresses}>Update Room</Button>
            </Grid>
        )
    }
    ...
    render()
    {
        ...
        <Grid container spacing={1}>
            <Grid item xs={12} align="center">
                <Collapse in={this.state.errorMessage != "" || this.state.sucessMessage !=""}>
